...
bool initFreeFallDetection() {
  ...
  if (status != 0) { 
    //Serial.print("CTRL_REG1 failed, status: "); Serial.println(status); 
    return false; 
  }
  ...
  if (status != 0) { 
    //Serial.print("CTRL_REG2 failed, status: "); Serial.println(status); 
    return false; 
  }
  ...
  if (status != 0) { 
    //Serial.print("CTRL_REG3 failed, status: "); Serial.println(status);
     return false;
  }
  ...
  if (status != 0) { 
    //Serial.print("CTRL_REG4 failed, status: "); Serial.println(status);
    return false;
  }
  ...
  if (status != 0) { 
    //Serial.print("CTRL_REG5 failed, status: "); Serial.println(status);
    return false;
  }
  ...
  if (status != 0) { 
    //Serial.print("INT1_THS failed, status: "); Serial.println(status); 
    return false; 
  }
  ...
  if (status != 0) { 
    //Serial.print("INT1_DURATION failed, status: "); Serial.println(status); 
    return false; 
  }
  ...
  if (status != 0) { 
    //Serial.print("INT1_CFG failed, status: "); Serial.println(status); 
    return false; 
  }
